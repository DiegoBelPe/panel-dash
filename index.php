            ...
            <div class="col-lg-5">
              <div class="card shadow-lg border-0 rounded-lg mt-5">
                <div class="card-header">
                  <p align="center"><img align="center" src="Logotipo-BarreMx.png" alt="Barre MX Logo" class="brand-image img-circle elevation-3" width="80" height="80"></p>
                </div>
                <div class="card-body">
                  <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0"><a class="small" href="password.html">¿Has olvidado tu contraseña?</a>
